...
|---------|--------|-----|----------------|-------|
| v2.4.2 | — | Published 2026-05-13 | Published | Patch release: fixes `proxyProfile` precedence over raw `proxy` and refreshes the lockfile so full `npm audit` is clean. |
